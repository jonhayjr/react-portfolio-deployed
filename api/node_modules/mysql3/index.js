...
class ConnectionPool {
    constructor(pool) {
        this.pool = pool;
        this.query = this._fwd('query');
        this.exec = this._fwd('exec');
        this.row = this._fwd('row');
        this.col = this._fwd('col');
        this.value = this._fwd('value');
        this.exists = this._fwd('exists');
        this.count = this._fwd('count');
        this.close = this.pool.end.bind(this.pool);
    }
    async getConnection() {
...
class PoolConnection {
    constructor(conn) {
        this.conn = conn;
        this.exec = this.query.bind(this);
        this.release = this.conn.release.bind(this.conn);
        this.beginTransaction = this.conn.beginTransaction.bind(this.conn);
        this.commit = this.conn.commit.bind(this.conn);
        this.rollback = this.conn.rollback.bind(this.conn);
        this.ping = this.conn.ping.bind(this.conn);
        this.changeUser = this.conn.changeUser.bind(this.conn);
        this.close = this.conn.end.bind(this.conn);
        this.destroy = this.conn.destroy.bind(this.conn);
        this.serverVersion = this.conn.serverVersion.bind(this.conn);
    }
    query(query) {
